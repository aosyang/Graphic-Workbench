...
{
	// Initialize key map
	DI_GWKeyCodeTable[	DIK_ESCAPE	] = 	GW_KEY_ESC	; /*	0x01	*/	
	...
	DI_GWKeyCodeTable[	DIK_LCONTROL	] = 	GW_KEY_LCTRL	; /*	0x1D	*/	
	...
	DI_GWKeyCodeTable[	DIK_LSHIFT	] = 	GW_KEY_LSHIFT	; /*	0x2A	*/	
	...
	DI_GWKeyCodeTable[	DIK_MULTIPLY	] = 	GW_KEY_NUMPAD_STAR	; /*	0x37	*/	/* * on numeric keypad */
	DI_GWKeyCodeTable[	DIK_LMENU	] = 	GW_KEY_LALT	; /*	0x38	*/	/* left Alt */
	DI_GWKeyCodeTable[	DIK_SPACE	] = 	GW_KEY_SPACE	; /*	0x39	*/	
	DI_GWKeyCodeTable[	DIK_CAPITAL	] = 	GW_KEY_CAPSLOCK	; /*	0x3A	*/	
	DI_GWKeyCodeTable[	DIK_F1	] = 	GW_KEY_F1	; /*	0x3B	*/	
	DI_GWKeyCodeTable[	DIK_F2	] = 	GW_KEY_F2	; /*	0x3C	*/	
	DI_GWKeyCodeTable[	DIK_F3	] = 	GW_KEY_F3	; /*	0x3D	*/	
	DI_GWKeyCodeTable[	DIK_F4	] = 	GW_KEY_F4	; /*	0x3E	*/	
	DI_GWKeyCodeTable[	DIK_F5	] = 	GW_KEY_F5	; /*	0x3F	*/	
	DI_GWKeyCodeTable[	DIK_F6	] = 	GW_KEY_F6	; /*	0x40	*/	
	DI_GWKeyCodeTable[	DIK_F7	] = 	GW_KEY_F7	; /*	0x41	*/	
	DI_GWKeyCodeTable[	DIK_F8	] = 	GW_KEY_F8	; /*	0x42	*/	
	DI_GWKeyCodeTable[	DIK_F9	] = 	GW_KEY_F9	; /*	0x43	*/	
	DI_GWKeyCodeTable[	DIK_F10	] = 	GW_KEY_F10	; /*	0x44	*/	
	DI_GWKeyCodeTable[	DIK_NUMLOCK	] = 	GW_KEY_NUMLOCK	; /*	0x45	*/	
	DI_GWKeyCodeTable[	DIK_SCROLL	] = 	GW_KEY_SCROLL	; /*	0x46	*/	/* Scroll Lock */
	DI_GWKeyCodeTable[	DIK_NUMPAD7	] = 	GW_KEY_NUMPAD7	; /*	0x47	*/	
	DI_GWKeyCodeTable[	DIK_NUMPAD8	] = 	GW_KEY_NUMPAD8	; /*	0x48	*/	
	DI_GWKeyCodeTable[	DIK_NUMPAD9	] = 	GW_KEY_NUMPAD9	; /*	0x49	*/	
	DI_GWKeyCodeTable[	DIK_SUBTRACT	] = 	GW_KEY_NUMPAD_MINUS	; /*	0x4A	*/	/* - on numeric keypad */
	DI_GWKeyCodeTable[	DIK_NUMPAD4	] = 	GW_KEY_NUMPAD4	; /*	0x4B	*/	
	DI_GWKeyCodeTable[	DIK_NUMPAD5	] = 	GW_KEY_NUMPAD5	; /*	0x4C	*/	
	DI_GWKeyCodeTable[	DIK_NUMPAD6	] = 	GW_KEY_NUMPAD6	; /*	0x4D	*/	
	DI_GWKeyCodeTable[	DIK_ADD	] = 	GW_KEY_NUMPAD_PLUS	; /*	0x4E	*/	/* + on numeric keypad */
	DI_GWKeyCodeTable[	DIK_NUMPAD1	] = 	GW_KEY_NUMPAD1	; /*	0x4F	*/	
	DI_GWKeyCodeTable[	DIK_NUMPAD2	] = 	GW_KEY_NUMPAD2	; /*	0x50	*/	
	DI_GWKeyCodeTable[	DIK_NUMPAD3	] = 	GW_KEY_NUMPAD3	; /*	0x51	*/	
	DI_GWKeyCodeTable[	DIK_NUMPAD0	] = 	GW_KEY_NUMPAD0	; /*	0x52	*/	
	DI_GWKeyCodeTable[	DIK_DECIMAL	] = 	GW_KEY_NUMPAD_DECIMAL	; /*	0x53	*/	/* . on numeric keypad */
	DI_GWKeyCodeTable[	DIK_OEM_102	] = 	GW_KEY_UNDEFINED	; /*	0x56	*/	/* <> or \| on RT 102-key keyboard (Non-U.S.) */
	DI_GWKeyCodeTable[	DIK_F11	] = 	GW_KEY_F11	; /*	0x57	*/	
	DI_GWKeyCodeTable[	DIK_F12	] = 	GW_KEY_F12	; /*	0x58	*/	
	...
	DI_GWKeyCodeTable[	DIK_DIVIDE	] = 	GW_KEY_NUMPAD_SLASH	; /*	0xB5	*/	/* / on numeric keypad */
	DI_GWKeyCodeTable[	DIK_SYSRQ	] = 	GW_KEY_UNDEFINED	; /*	0xB7	*/	
	DI_GWKeyCodeTable[	DIK_RMENU	] = 	GW_KEY_UNDEFINED	; /*	0xB8	*/	/* right Alt */
	DI_GWKeyCodeTable[	DIK_PAUSE	] = 	GW_KEY_PAUSE	; /*	0xC5	*/	/* Pause */
	DI_GWKeyCodeTable[	DIK_HOME	] = 	GW_KEY_HOME	; /*	0xC7	*/	/* Home on arrow keypad */
	DI_GWKeyCodeTable[	DIK_UP	] = 	GW_KEY_UP	; /*	0xC8	*/	/* UpArrow on arrow keypad */
	DI_GWKeyCodeTable[	DIK_PRIOR	] = 	GW_KEY_PAGEUP	; /*	0xC9	*/	/* PgUp on arrow keypad */
	...
	DI_GWKeyCodeTable[	DIK_END	] = 	GW_KEY_END	; /*	0xCF	*/	/* End on arrow keypad */
	DI_GWKeyCodeTable[	DIK_DOWN	] = 	GW_KEY_DOWN	; /*	0xD0	*/	/* DownArrow on arrow keypad */
	DI_GWKeyCodeTable[	DIK_NEXT	] = 	GW_KEY_PAGEDOWN	; /*	0xD1	*/	/* PgDn on arrow keypad */
	DI_GWKeyCodeTable[	DIK_INSERT	] = 	GW_KEY_INSERT	; /*	0xD2	*/	/* Insert on arrow keypad */
	DI_GWKeyCodeTable[	DIK_DELETE	] = 	GW_KEY_DELETE	; /*	0xD3	*/	/* Delete on arrow keypad */
